...
$label = ["2023-2024", "2024-2025", "2025-2026"];

for ($i = 0; $i < count($label); $i++) {
    $query = mysqli_query($koneksi, "SELECT COUNT(*) as jml FROM `data_calon_siswa` WHERE tahun_masuk = '" . $label[$i] . "';");
    $row = $query->fetch_array();

    $jumlah_siswa[] = $row['jml'];
}
?>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="grafik.php" class="nav-item nav-link active">Grafik</a>
            </div>
    ...
    var myChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'GRAFIK TOTAL PENERIMAAN CALON SISWA',
